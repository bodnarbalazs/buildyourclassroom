...
_CA_ACTION = ELEMENT_TYPE_TO_CA_ACTION[LessonElementType.GROUP_ACTIVITY]


class GroupActivityElement(BaseModel):
    element_type: Literal[LessonElementType.GROUP_ACTIVITY] = LessonElementType.GROUP_ACTIVITY
